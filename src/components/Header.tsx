...
const Header = ({ openLogin, openRegister }: HeaderProps) => {
  ...
  const buySellRef = useRef<HTMLLIElement>(null);
        ...
        <div className="container-fluid">
          ...
          <div className="desktop-menu d-none d-lg-flex">
              ...
              <li className="nav-item dropdown" ref={buySellRef}>
                ...
                {buySellOpen && (
                  <div className="dropdown-menu show-drop">
                    ...
                    <Link to="/buy/collection">Buy Collection</Link>
            ...
            <div className="right-btns d-flex gap-3">
              <button className="btn btn-outline-success" onClick={openLogin}>
                Sign In
              </button>
